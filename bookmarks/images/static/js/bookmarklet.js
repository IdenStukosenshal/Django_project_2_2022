(function(){
  ...
  var site_url = 'https://bdff-212-164-204-167.eu.ngrok.io/';
  ...
  if(typeof window.jQuery != 'undefined') {
    ...
    // Create the script and point to Google API  Создание тега <script> с загрузкой jQuery.
    ...
    (function(){
      ...
      if(typeof window.jQuery == 'undefined') {
        if(--attempts > 0) {
          // Calls himself in a few milliseconds  Если не подключена, пытаемся снова загрузить
