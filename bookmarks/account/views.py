...
* не работает ngrok и csrf, из-за чего возможно нельзя проверить работу java script -а
* не показывает превью при альтернативном добавлении, а при вставке в url строку в браузере показывает
* AJAX не понятен вообще"""
